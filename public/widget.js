"use strict";(()=>{var N=Object.defineProperty;var H=Object.getOwnPropertySymbols;var j=Object.prototype.hasOwnProperty,A=Object.prototype.propertyIsEnumerable;var B=(n,e,t)=>e in n?N(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,z=(n,e)=>{for(var t in e||(e={}))j.call(e,t)&&B(n,t,e[t]);if(H)for(var t of H(e))A.call(e,t)&&B(n,t,e[t]);return n};var g=(n,e,t)=>B(n,typeof e!="symbol"?e+"":e,t);function O(n){return`
  ...
  `}var $="rr_chat_session",L="rr_chat_messages";function R(n){var t,s;let e=document.querySelectorAll("script[src*='widget.js']");for(let i of e)try{return new URL(i.src).origin}catch(o){}return(s=(t=window.ChatWidget)==null?void 0:t.apiBase)!=null?s:""}function C(n){return new Date(n).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}function c(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function D(n){var i;let e=n.trim().replace(/\s+/g," "),s=((i=e.split("|").map(o=>o.trim()).filter(Boolean)[0])!=null?i:e)||"Source";return s.length>32?`${s.slice(0,29)}\u2026`:s}function _(n){return n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function U(n,e){var s;let t=c(n);if(t=t.replace(/\[\[([^\]|]{1,120})\|((?:https?):\/\/[^\s<>"']{1,2048})\]\]/g,(i,o,a)=>{let l=String(o).trim(),r=String(a).trim();return!l||!r?"":`<a class="intext-source" href="${c(r)}" target="_blank" rel="noopener">${c(l)}</a>`}),t=t.replace(/\bhttps?:\/\/[^\s<>"']+/gi,i=>`<a class="intext-source" href="${c(i)}" target="_blank" rel="noopener">${c(i)}</a>`),!(e!=null&&e.length))return t;for(let i of e.slice(0,5)){if(!(i!=null&&i.url))continue;let o=(i.title||"").trim(),a=((s=o.split("|")[0])!=null?s:o).trim(),l=D(o||i.url||"Source"),r=Array.from(new Set([a,o,l].map(p=>p.trim()).filter(Boolean))),d=!1;for(let p of r){let h=c(p),u=new RegExp(`\\b${_(h)}\\b`,"i");if(u.test(t)){t=t.replace(u,`<a class="intext-source" href="${c(i.url)}" target="_blank" rel="noopener">${h}</a>`),d=!0;break}}}return t}var S=class{constructor(e){g(this,"shadow");g(this,"host");g(this,"config",null);g(this,"messages",[]);g(this,"siteId");g(this,"baseUrl");g(this,"sessionId",null);g(this,"token",null);g(this,"isOpen",!1);g(this,"isStreaming",!1);this.siteId=e,this.baseUrl=R(e),this.host=document.createElement("div"),this.host.id="rr-chat-widget",this.host.style.cssText="position:fixed;z-index:999999;",document.body.appendChild(this.host),this.shadow=this.host.attachShadow({mode:"closed"}),this.init()}async init(){try{let s=await fetch(`${this.baseUrl}/api/v1/widget-config?siteId=${this.siteId}`);if(!s.ok){s.status===404&&this.host.remove();return}this.config=await s.json()}catch(s){this.config={id:this.siteId,primaryColor:"#6366f1",title:"Chat",greeting:"Hi! How can I help you today?",allowedTopics:[]}}if(!this.host.isConnected)return;let e=sessionStorage.getItem(`${$}:${this.siteId}`);if(e)try{let{sessionId:s,token:i}=JSON.parse(e);this.sessionId=s,this.token=i}catch(s){}let t=sessionStorage.getItem(`${L}:${this.siteId}`);if(t)try{this.messages=JSON.parse(t)}catch(s){}this.render(),this.attachListeners()}saveSession(){this.sessionId&&this.token&&sessionStorage.setItem(`${$}:${this.siteId}`,JSON.stringify({sessionId:this.sessionId,token:this.token})),sessionStorage.setItem(`${L}:${this.siteId}`,JSON.stringify(this.messages))}render(){var s,i,o,a,l,r,d,p,h,u,f;let e=(i=(s=this.config)==null?void 0:s.primaryColor)!=null?i:"#6366f1",t=(r=(l=(o=this.config)==null?void 0:o.logoUrl)!=null?l:(a=window.ChatWidget)==null?void 0:a.pageIconUrl)!=null?r:null;this.shadow.innerHTML=`
      <style>${O(e)}</style>
